...
class UserRegistrationSchema(Schema):
    ...
    # Role is intentionally not accepted during public registration.
    # New users default to 'viewer' and roles are managed via admin endpoints.
...
class AdminUserCreateSchema(UserRegistrationSchema):
    """
    Validates admin-only user creation input.

    Extends public registration by allowing an explicit role assignment.
    """
